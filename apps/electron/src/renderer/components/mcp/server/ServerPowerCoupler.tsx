  ...
  return (
    <button
      ...
      className={cn(
        ...
        isLive &&
          "border-primary/70 bg-[linear-gradient(135deg,hsl(var(--primary)/0.18),hsl(var(--primary)/0.05))] shadow-[inset_0_0_0_1px_hsl(var(--primary)/0.15)]",
        !isLive &&
          !isError &&
    ...
    >
      ...
      <span
        ...
        className={cn(
          ...
          isLive ? "bg-primary/55" : "bg-muted-foreground/25",
        )}
      />
      ...
      <span
        ...
        className={cn(
          ...
          isLive
            ? "left-[calc(100%-1.45rem)] border-primary bg-primary text-white shadow-[0_0_12px_hsl(var(--primary)/0.45)]"
